                    ...
                    <div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
                        ...
                        <div class="main_nav_container ml-auto">
                            <ul class="main_nav_list">
                                ...
                                <li class="main_nav_item"><a href="about.html">О нас</a></li>Сервисы</a></li>
    ...
    <div class="menu trans_500">
        <div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
            ...
            <ul>
                ...
                <li class="menu_item"><a href="contact.html">cКонтакты</a></li>
            </ul>
        </div>
    </div>
                ...
                <div class="col-lg-3 footer_column">
                    <div class="footer_col">
                        <div class="footer_content footer_about">
                            ...
                            <p class="footer_about_text">“Travelix” - это ведущее туристическое агентство, которое предлагает незабываемые путешествия по всему миру. Мы специализируемся на создании индивидуальных маршрутов, которые соответствуют уникальным желаниям и бюджету наших клиентов.</p>
                        ...
                        <div class="footer_content footer_contact">
                            <ul class="contact_info_list">
                                <li class="contact_info_item d-flex flex-row">
                                    ...
                                    <div class="contact_info_text">428000 г.Чебоксары, ул.Шумилова, д.99</div>
                                </li>
                                <li class="contact_info_item d-flex flex-row">
